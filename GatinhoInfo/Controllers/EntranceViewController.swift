...
class EntranceViewController: UIViewController {
    ...
    private lazy var labelName: UILabel = {
        let label = UILabel()
        label.text = StringsEnum.appName.localize()
        label.textAlignment = .center
        label.textColor =  #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)
      label.font = UIFont(name: StringsEnum.entranceFont.localize(), size: 50)
    ...
    private lazy var checkCatsButton: UIButton = {
        let button = UIButton()
      button.setTitle(StringsEnum.entranceButtonText.localize(), for: .normal)
        button.backgroundColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)
        button.titleLabel?.textColor = #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0)
      button.titleLabel?.font = UIFont(name: StringsEnum.entranceButtonText.localize(), size: 25)
    ...
    @objc func buttonClicked(sender: UIButton) {
        ...
        let vController = TableViewController(viewModel: viewModel)
