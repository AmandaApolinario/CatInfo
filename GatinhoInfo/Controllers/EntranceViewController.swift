...
class EntranceViewController: UIViewController {
    ...
    private lazy var labelName: UILabel = {
        let label = UILabel()
        label.text = StringsEnum.AppName.rawValue.localize()
        label.textAlignment = .center
        label.textColor =  #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)
      label.font = UIFont(name: StringsEnum.EntranceFont.rawValue.localize() , size: 50)
    ...
    private lazy var checkCatsButton: UIButton = {
        let button = UIButton()
      button.setTitle(StringsEnum.EntranceButtonText.rawValue.localize(), for: .normal)
        button.backgroundColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)
        button.titleLabel?.textColor = #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0)
      button.titleLabel?.font = UIFont(name: StringsEnum.EntranceButtonText.rawValue.localize() , size: 25)
